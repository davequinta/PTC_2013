 ...
 * @author Todos
 */
public class subman extends javax.swing.JFrame {

    /**
     * Creates new form subman
     */
    public subman() {
        initComponents();
        
         
         frmdi fondo = new frmdi("/imagenes/fondomant.png",500, 300);
        this.pf.add(fondo);
        this.pf.repaint();//Refrescar
        
        frmdi fondo1= new frmdi("/imagenes/riego.png",128, 128);
        this.p1.add(fondo1);
        this.p1.repaint();//Refrescar
        
        frmdi fondo2 = new frmdi("/imagenes/man.png",128, 128);
        this.p2.add(fondo2);
        this.p2.repaint();//Refrescar
        
        frmdi fondo3 = new frmdi("/imagenes/tipom.png",128, 128);
        this.p3.add(fondo3);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(subman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
