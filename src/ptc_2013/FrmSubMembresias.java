...
/*
 * FrmSubMembresias.java
 *
 * Created on 25-ago-2013, 22:19:00
 */
package ptc_2013;
 ...
 * @author Toshiba
 */
public class FrmSubMembresias extends javax.swing.JFrame {

    /** Creates new form FrmSubMembresias */
    public FrmSubMembresias() {
        initComponents();
        setTitle("SubMembresias");
        frmdi fondo = new frmdi("/img/fondomem.png",400, 300);
        this.pnlfondo.add(fondo);
        this.pnlfondo.repaint();//Refrescar
        frmdi fondo2 = new frmdi("/img/tipomem.png",128, 128);
        this.pnl1.add(fondo2);
        this.pnl1.repaint();//Refrescar
        frmdi fondo3 = new frmdi("/img/afiliados.png",128, 128);
    ...
    private void initComponents() {
        ...
        pnl2.setBackground(new java.awt.Color(102, 255, 102));
...
obj.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSubMembresias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new FrmSubMembresias().setVisible(true);
            }
        });
    }
