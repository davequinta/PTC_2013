 ...
 * @author David
 */
public class FrmZona_mante extends javax.swing.JFrame {

    /**
     * Creates new form FrmZona_mante
     */
    public FrmZona_mante() {
        initComponents();
    ...
    {
        MtoZona_mante obj = new  MtoZona_mante();
    ...
    private void initComponents() {
        ...
        setTitle("Asignación de matenimiento");
    ...
    private void btnagregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnagregarActionPerformed
        ...
        obj.setId_mantenimiento(codigo1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmZona_mante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmZona_mante().setVisible(true);
            }
        });
    }
