...
/*
 * FrmSubVisitantes.java
 *
 * Created on 25-ago-2013, 22:19:59
 */
package ptc_2013;
 ...
 * @author Toshiba
 */
public class FrmSubVisitantes extends javax.swing.JFrame {

    /** Creates new form FrmSubVisitantes */
    public FrmSubVisitantes() {
        initComponents();
        setTitle("SubVisitantes");
        frmdi fondo = new frmdi("/img/visitante.png",400, 300);
        this.pnlfondo.add(fondo);
        this.pnlfondo.repaint();//Refrescar
        frmdi fondo2 = new frmdi("/img/vis.png",128, 128);
        this.pnl1.add(fondo2);
        this.pnl1.repaint();//Refrescar
        frmdi fondo3 = new frmdi("/img/tipovispng.png",128, 128);
    ...
    private void initComponents() {
        ...
        pnl1.setBackground(new java.awt.Color(102, 102, 0));
        ...
        pnl2.setBackground(new java.awt.Color(102, 102, 0));
...
obj.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSubVisitantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new FrmSubVisitantes().setVisible(true);
            }
        });
    }
