 ...
 * @author Todos
 */
public class subvis extends javax.swing.JFrame {

    /**
     * Creates new form subvis
     */
    public subvis() {
        initComponents();
        frmdi fondo = new frmdi("/imagenes/fondovis.png",477, 300);
        this.pf.add(fondo);
        this.pf.repaint();//Refrescar
        
        frmdi fondo1= new frmdi("/imagenes/vis.png",128, 128);
        this.p1.add(fondo1);
        this.p1.repaint();//Refrescar
        
        frmdi fondo2 = new frmdi("/imagenes/vis2.png",128, 128);
        this.p2.add(fondo2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(subvis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
