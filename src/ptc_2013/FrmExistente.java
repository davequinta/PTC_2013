 ...
 * @author David
 */
public class FrmExistente extends javax.swing.JFrame {
int codigo;
    /**
    ...
    public void cargarCodigo(){
        ...
        MtoPlantas obj = new MtoPlantas();
         ...
         obj.setCorrelativo(codigo);
         if(obj.Stock())
        {                             
            txtExi.setText(String.valueOf(obj.getStock()));
    ...
    private void btnagregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnagregarActionPerformed
        ...
        MtoPlantas obj = new MtoPlantas();
        obj.setCorrelativo(codigo);
        obj.setStock(Integer.parseInt(txtExi.getText()));
        obj.setExis(Integer.parseInt(txtStock.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmExistente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmExistente().setVisible(true);
            }
        });
    }
