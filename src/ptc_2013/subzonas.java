 ...
 * @author Todos
 */
public class subzonas extends javax.swing.JFrame {

    /**
     * Creates new form subzonas
     */
    public subzonas() {
        initComponents();
        
         frmdi fondo = new frmdi("/imagenes/fondoz.png",400, 300);
        this.pf.add(fondo);
        this.pf.repaint();//Refrescar
        
        frmdi fondo1= new frmdi("/imagenes/zona.png",128, 128);
        this.p1.add(fondo1);
        this.p1.repaint();//Refrescar
        
        frmdi fondo2 = new frmdi("/imagenes/zona2.png",128, 128);
        this.p2.add(fondo2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(subzonas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
