...
/*
 * FrmSubMantenimiento.java
 *
 * Created on 25-ago-2013, 22:17:35
 */
package ptc_2013;
 ...
 * @author Toshiba
 */
public class FrmSubMantenimiento extends javax.swing.JFrame {

    /** Creates new form FrmSubMantenimiento */
    public FrmSubMantenimiento() {
        initComponents();
        setTitle("SubMantenimiento");
        frmdi fondo = new frmdi("/img/mantenimiento.png",500, 300);
        this.pnlfondo.add(fondo);
        this.pnlfondo.repaint();//Refrescar
        frmdi fondo2 = new frmdi("/img/mante.png",128, 128);
        this.pnl1.add(fondo2);
        this.pnl1.repaint();//Refrescar
        frmdi fondo3 = new frmdi("/img/empleman.png",128, 128);
        this.pnl2.add(fondo3);
        this.pnl2.repaint();//Refrescar
        frmdi fondo4 = new frmdi("/img/tipomante.png",128, 128);
    ...
    private void initComponents() {
        ...
        pnl1.setBackground(new java.awt.Color(255, 102, 102));
        ...
        pnl2.setBackground(new java.awt.Color(255, 102, 102));
        ...
        pnl3.setBackground(new java.awt.Color(153, 255, 153));
...
obj.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSubMantenimiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new FrmSubMantenimiento().setVisible(true);
            }
        });
    }
