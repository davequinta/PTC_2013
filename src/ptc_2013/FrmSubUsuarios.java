 ...
 * FrmSubUsuarios.java
 *
 * Created on 25-ago-2013, 22:19:42
 */
package ptc_2013;
 ...
 * @author Toshiba
 */
public class FrmSubUsuarios extends javax.swing.JFrame {

    /** Creates new form FrmSubUsuarios */
    public FrmSubUsuarios() {
        initComponents();
        setTitle("SubUsuarios");
        frmdi fondo = new frmdi("/img/usuarios.png",400, 300);
        this.pnlfondo.add(fondo);
        this.pnlfondo.repaint();//Refrescar
        frmdi fondo2 = new frmdi("/img/usu.png",128, 128);
        this.pnl1.add(fondo2);
        this.pnl1.repaint();//Refrescar
        frmdi fondo3 = new frmdi("/img/tipousu.png",128, 128);
    ...
    private void initComponents() {
        ...
        pnl1.setBackground(new java.awt.Color(153, 255, 153));
        ...
        pnl2.setBackground(new java.awt.Color(102, 102, 255));
...
obj.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSubUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new FrmSubUsuarios().setVisible(true);
            }
        });
    }
