...
public class subempleados extends javax.swing.JFrame {
    ...
    public subempleados() {
        initComponents();
         frmdi fondo = new frmdi("/imagenes/fondoemple.png",500, 300);
        this.pf.add(fondo);
        this.pf.repaint();//Refrescar
        
        frmdi fondo1= new frmdi("/imagenes/emple.png",128, 128);
        this.p1.add(fondo1);
        this.p1.repaint();//Refrescar
        
        frmdi fondo2 = new frmdi("/imagenes/tiemple.png",128, 128);
        this.p2.add(fondo2);
        this.p2.repaint();//Refrescar
        
        frmdi fondo3 = new frmdi("/imagenes/zoemple.png",128, 128);
        this.p3.add(fondo3);
    ...
    private void p3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_p3MouseClicked
      FrmZona_Emple obj = new FrmZona_Emple();
        obj.setVisible(true);
